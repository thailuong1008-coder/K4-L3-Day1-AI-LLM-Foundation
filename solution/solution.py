...
def compare_models(prompt: str) -> dict:
    ...
    """
    gpt4o_res,gpt4o_la=call_openai(prompt)
    mini_res, mini_la=call_openai_mini(prompt)
    cost=(len(gpt4o_res.split())/0.75)/1000  *PRICING_PER_1K_TOKENS["gpt-4o"]["output"]
    return { "gpt4o_response":      gpt4o_res
                , "mini_response":       mini_res
                , "gpt4o_latency":       gpt4o_la
                , "mini_latency":        mini_la
